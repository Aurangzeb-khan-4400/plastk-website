...
import { subTitle, fourCols, twoCols } from './SignUpStep1.styles';
import embossList from '../../helpers/embossList';
import { CardTypes, Title, SurveyOptions, WhyWantCardOptions } from '../../data/FormData';
      ...
      onTouched={e => {
        if (['first_name', 'last_name', 'middle_name'].includes(Object.keys(e)[0])) {
          ...
          if (options.filter(({ value }) => value === emboss?.value)[0] === undefined) {
            form.setFieldsValue({ emboss: { value: undefined, label: undefined } });
